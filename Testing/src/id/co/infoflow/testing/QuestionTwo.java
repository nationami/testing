	...
	public static void main(String[] args) {
		...
		try (Scanner scanner = new Scanner(System.in)) {
    		...
    		for(int i=0;i<vertices;i++){
	            System.out.print("Enter edges name : ");
	            
	            String edges = scanner.next();
	            
	            while(edgesWeight.containsKey(edges)){
	            	System.out.print("Edges name already exists please input new name : ");
	            	edges = scanner.next();
	            }
	            
	            System.out.print("Enter edges weight : ");
	            
	            while (!scanner.hasNextInt()) {
	            	System.out.print("Please input number weight : ");
	            	scanner.next();
	            }
